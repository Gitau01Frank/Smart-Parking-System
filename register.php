...
<body>
    <div class="container">
        ...
        <form action="" method="POST" id="theForm">
            ...
            <input type="text" class="input" name="name" <?php post_value("name"); ?>-attr-name"><?php post_value("name"); ?>

            <label for="user_email">Email: <span></span></label>
            <input type="email" class="input" name="email" <?php post_value("email"); ?>-attr-name"><?php post_value("email"); ?>

            <label for="user_pass">Password: <span></span></label>
            <input type="password" class="input" name="password" <?php post_value("password"); ?>-attr-name"><?php post_value("password"); ?>
